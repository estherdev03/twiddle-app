    ...
    <>
      <div className="flex flex-col lg:flex-row gap-5 p-5">
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <p
            className="text-light-1 text-xl lg:text-3xl mb-5 lg:mb-10 text-center lg:text-left
          "
          >
            Join today
          </p>
          ...
          <SignUpButton>
            <button className="lg:w-full text-black mx-5 my-2 lg:mx-0 lg:my-2 px-6 py-2 rounded-lg bg-emerald-100 hover:bg-green-200">
              Register
            </button>
          </SignUpButton>
        </div>
